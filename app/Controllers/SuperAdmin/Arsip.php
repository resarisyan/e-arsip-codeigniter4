...
class Arsip extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('superadmin/arsip', $data);
    }
    ...
    public function view($kode_arsip)
    {
        ...
        return view('superadmin/arsip_view', $data);
    }
    ...
    public function ajaxList()
    {
        ...
        foreach ($list as $mylist) {
            ...
            $file = '
            <div class="text-center">
                <a href="' . route_to('superadmin.arsip.view', $mylist['no_arsip']) . '" class="d-block "><i class="fas fa-file-pdf fa-2x label-danger"></i></a>
    ...
    function ajaxSave()
    {
        ...
        $data = [
            ...
            'id_departemen' => $this->request->getVar('departemen'),
    ...
    public function _validate($method)
    {
        if (!$this->validate($this->arsip->getRulesValidation($method))) {
            ...
            if ($validation->hasError('departemen')) {
                $data['inputerror'][] = 'departemen';
                $data['error_string'][] = $validation->getError('departemen');
                $data['status'] = FALSE;
            }
