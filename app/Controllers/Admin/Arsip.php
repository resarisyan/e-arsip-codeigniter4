...
class Arsip extends BaseController
{
    ...
    public function view($kode_arsip)
    {
        ...
        if (isset($data['arsip'])) {
            return view('admin/arsip_view', $data);
        } else {
            session()->setFlashdata('error', 'No Arsip Tidak Ditemukan');
            return redirect()->to(route_to('admin.arsip'));
        }
    }
    ...
    public function ajaxList()
    {
        ...
        foreach ($list as $mylist) {
            ...
            $file = '
            <div class="text-center">
                <a href="' . route_to('admin.arsip.view', $mylist['no_arsip']) . '" class="d-block "><i class="fas fa-file-pdf fa-2x label-danger"></i></a>
