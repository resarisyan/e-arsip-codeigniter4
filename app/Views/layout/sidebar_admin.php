     ...
     <div class="sidebar">
         ...
         <nav class="mt-2">
             <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                 <li class="nav-item">
                     <a href="<?= route_to('admin.dashboard'); ?>" class="nav-link <?= ($halaman == 'dashboard') ? 'active' : '' ?>">
                 ...
                 <li class="nav-item">
                     <a href="<?= route_to('admin.kategori'); ?>" class="nav-link <?= ($halaman == 'kategori') ? 'active' : '' ?>">
                 ...
                 <li class="nav-item">
                     <a href="<?= route_to('admin.arsip') ?>" class="nav-link <?= ($halaman == 'arsip') ? 'active' : '' ?>">
                 ...
                 <li class="nav-item">
                     <a href="<?= route_to('admin.user') ?>" class="nav-link <?= ($halaman == 'user') ? 'active' : '' ?>">
