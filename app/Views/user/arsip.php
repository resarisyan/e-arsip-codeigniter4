...
<?= $this->section('script'); ?>
<script>
    let urlList = "<?= route_to('user.arsip.ajaxList') ?>";
    let urlSave = "<?= route_to('user.arsip.ajaxSave') ?>";
    let urlEdit = "<?= base_url() ?>/user/arsip/ajaxEdit/";
    let urlUpdate = "<?= base_url() ?>/user/arsip/ajaxUpdate/";
    let urlDelete = "<?= base_url() ?>/user/arsip/ajaxDelete/";
    let urlStatus = "<?= base_url() ?>/user/arsip/ajaxStatus/";
    let urlFile = "<?= base_url(); ?>/uploads/arsip/";
</script>
<script src="<?= base_url(); ?>/ajax_user/ajaxArsip.js"></script>
<?= $this->endSection(); ?>
...
<?= $this->include('form_user/form_arsip'); ?>
<?= $this->endSection(); ?>